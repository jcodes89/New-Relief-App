    ...
    <section>
      <main className='hero'>
        <div className=' h-screen w-screen flex place-content-center items-center'>
          <HeroMain/>
          <span className='opacity-50 z-0 bg-[url("../public/images/austin-kehmeier-lyiKExA4zQA-unsplash-small.jpg")] absolute bg-no-repeat h-screen w-screen bg-cover bg-center'/>
        </div>
      </main>
    </section>
